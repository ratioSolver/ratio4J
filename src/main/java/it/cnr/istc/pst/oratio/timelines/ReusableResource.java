...
import it.cnr.istc.pst.oratio.Timeline;
import it.cnr.istc.pst.oratio.TimelineExtractor;
import it.cnr.istc.pst.oratio.Item.ArithItem;
import it.cnr.istc.pst.oratio.Timeline.TimelineValue;

public class ReusableResource implements Timeline<ReusableResource.RRValue> {

    public static TimelineExtractor EXTRACTOR = new ReusableResourceExtractor();
    ...
    private static class ReusableResourceExtractor implements TimelineExtractor {
