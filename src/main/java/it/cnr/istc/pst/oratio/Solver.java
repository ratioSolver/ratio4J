...
public class Solver implements Scope, Env {
    ...
    public Solver(final boolean build_timelines_at_state_change, final boolean build_timelines_at_solution_found) {
        ...
        timelines.addExtractor(types.get("StateVariable"), StateVariable.EXTRACTOR);
        timelines.addExtractor(types.get("ReusableResource"), ReusableResource.EXTRACTOR);
        timelines.addExtractor(types.get("Agent"), Agent.EXTRACTOR);
    }
