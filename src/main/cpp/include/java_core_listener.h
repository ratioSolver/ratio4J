...
namespace ratio::java
{
  ...
  class java_core_listener : public scoped_env, public ratio::core::core_listener
  {
  public:
    java_core_listener(ratio::core::core &cr, JNIEnv *env, jobject obj);
    ~java_core_listener();
  ...
  private:
    ...
    void new_type(JNIEnv *env, const ratio::core::type &t);
    void revise_type(JNIEnv *env, const ratio::core::type &t);
    void new_predicate(JNIEnv *env, const ratio::core::predicate &p);
    void revise_predicate(JNIEnv *env, const ratio::core::predicate &p);

    void new_item(JNIEnv *env, const ratio::core::item &itm);
    void new_atom(JNIEnv *env, const ratio::core::atom &atm);

    jobject new_field(JNIEnv *env, const std::string &name, const ratio::core::type &tp);
    jobjectArray new_fields_array(JNIEnv *env, const std::vector<const ratio::core::field *> &args);
    jobject set(JNIEnv *env, jobject c_obj, jmethodID mthd_id, const std::string &name, const ratio::core::item &itm);
  ...
  private:
    ...
    std::unordered_map<const ratio::core::type *, jobject> all_types;
    std::unordered_map<const ratio::core::item *, jobject> all_items;
  };
} // namespace ratio::java